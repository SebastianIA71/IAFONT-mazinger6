---
layout: post
title:  "La IA transforma la arquitectura"
author: sebastian
...
- [TestFit.io](https://www.testfit.io/) automatiza layouts según restricciones de solar, normativa o rentabilidad.
- [Autodesk Forma](https://www.autodesk.com/forma) permite evaluar desde el diseño el impacto energético y climático.
- [Hypar.io](https://hypar.io/) genera soluciones de ingeniería en segundos, listas para producción.
...
1. **Experimenta con herramientas IA**: Prueba [Midjourney](https://www.midjourney.com/), [LookX](https://lookx.ai), [Forma](https://www.autodesk.com/forma).
2. **Comprende la lógica algorítmica**: Aprende bases de datos, lógica de entrenamiento y sesgos. Hay cursos gratuitos en [Coursera](https://www.coursera.org/), [edX](https://www.edx.org/) o [ArchDaily](https://www.archdaily.com/tag/artificial-intelligence).
3. **Trabaja en equipos multidisciplinarios**: Diseñadores, ingenieros de datos, sociólogos urbanos.
4. **Rediseña tu flujo creativo**: Usa la IA como exploración, pero decide siempre con intención.
