---
layout: post
title:  "¿Estás filtrando tus secretos a la IA?"
author: iago
categories: [IA, SOCIEDAD]
image: assets/images/1049.jpg
tags: [featured]
...
1. **Falta de conocimiento**: muchos empleados no comprenden que las IA públicas no son seguras por defecto.
2. **Ausencia de directrices claras**: apenas un 4% de las empresas analizadas contaban con políticas específicas sobre el uso de IA, según datos de [Gartner](https://www.gartner.com/en/newsroom/press-releases/2023-09-13-gartner-survey-finds-45-percent-of-enterprises-are-piloting-generative-ai).
3. **Presión por entregar más rápido**: la eficiencia operativa ha desplazado la reflexión ética y la seguridad.
...
Incorpora soluciones de DLP como [Microsoft Purview](https://www.microsoft.com/security/business/information-protection/microsoft-purview-data-loss-prevention), [Nightfall](https://nightfall.ai/) o [Cyberhaven](https://www.cyberhaven.com/).
...
Sí, a menos que uses versiones API empresariales con configuración específica. Consulta sus [políticas de privacidad](https://openai.com/enterprise-privacy).

**¿Existe alguna forma de usar IA sin exponer datos sensibles?**  
Sí, puedes optar por modelos privados como [Mistral](https://mistral.ai), desplegar tu propio LLM o usar soluciones privadas como [Azure OpenAI](https://azure.microsoft.com/en-us/products/cognitive-services/openai-service).
