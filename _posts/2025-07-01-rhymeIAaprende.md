...
tags: [featured]
iarts: ["a humanoid robot watching a screen attentively with scenes of household tasks playing, learning through observation in a futuristic lab"]
---
**Un sistema robótico que observa, comprende y actúa**. Eso es lo que propone el nuevo marco RHyME (Robotic Hierarchical Modular Environment), un avance que podría revolucionar cómo aprenden los robots. Esta innovación utiliza inteligencia artificial para que los robots aprendan **solo observando vídeos**, sin necesidad de codificación manual o entrenamiento específico para cada tarea.
...
- [Robot see, robot do – Cornell Chronicle](https://news.cornell.edu/stories/2025/04/robot-see-robot-do-system-learns-after-watching-how-tos)
- [Paper en ArXiv: One‑Shot Imitation under Mismatched Execution](https://arxiv.org/abs/2409.06615)
- [Portal técnico de RHyME en Cornell](https://portal.cs.cornell.edu/rhyme)
